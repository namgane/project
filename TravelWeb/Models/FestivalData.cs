        ...
        public static List<Festival> GetAll()
        {
            var festivals = new List<Festival>
            {
                ...
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/chuahuongp2.webp", "/images/festivals/chuahuongp1.webp", "/images/festivals/chuahuongp3.webp" }
                },
                new Festival {
                    Name = "Lễ hội Lim",
                    Province = "Bắc Ninh",
                    ...
                    ImageUrls = new List<string> { "/images/festivals/hoilimp1.webp", "/images/festivals/hoilimp2.webp", "/images/festivals/hoilimp3.webp" }
                },
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/hoidentranp1.webp", "/images/festivals/hoidentranp2.webp", "/images/festivals/hoidentranp3.webp" }
                },
                ...
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/caphep1.webp", "/images/festivals/caphep2.webp", "/images/festivals/caphep3.webp" }
                },
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/denhungp1.webp", "/images/festivals/denhungp1.webp", "/images/festivals/denhungp1.webp" }
                },
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/voip1.webp", "/images/festivals/voip2.webp", "/images/festivals/voip3.webp" }
                },
                ...
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/festival-hue.jpg", "/images/festivals/festival-hue-2.jpg", "/images/festivals/festival-hue-3.jpg" }
                },
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/phao-hoa-danang.jpg", "/images/festivals/phao-hoa-danang-2.jpg", "/images/festivals/phao-hoa-danang-3.jpg" }
                },
                ...
                new Festival {
                    ...
                    Province = "Ninh Thuận",
                    Region = "Miền Trung",
                    StartDate = new DateTime(DateTime.Now.Year, 9, 28), // Chỉnh tháng sang Thu
                    EndDate = new DateTime(DateTime.Now.Year, 9, 29),
                    ...
                    ImageUrls = new List<string> { "/images/festivals/kate.jpg", "/images/festivals/kate-2.jpg", "/images/festivals/kate-3.jpg" }
                },
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/vu-lan.jpg", "/images/festivals/vu-lan-2.jpg", "/images/festivals/vu-lan-3.jpg" }
                },
                ...
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/nghinh-ong.jpg", "/images/festivals/nghinh-ong-2.jpg", "/images/festivals/nghinh-ong-3.jpg" }
                },
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/dua-ghe-ngo.jpg", "/images/festivals/dua-ghe-ngo-2.jpg", "/images/festivals/dua-ghe-ngo-3.jpg" }
                },
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/ok-om-bok.jpg", "/images/festivals/ok-om-bok-2.jpg", "/images/festivals/ok-om-bok-3.jpg" }
                },
                ...
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/hoa-da-lat.jpg", "/images/festivals/hoa-da-lat-2.jpg", "/images/festivals/hoa-da-lat-3.jpg" }
                },
                new Festival {
                    ...
                    ImageUrls = new List<string> { "/images/festivals/countdown-sg.jpg", "/images/festivals/countdown-sg-2.jpg", "/images/festivals/countdown-sg-3.jpg" }
                }
            };

            // Gán ID tự động cho danh sách (Quan trọng cho nút Details)
            int currentId = 1;
            foreach (var festival in festivals)
            {
                festival.Id = currentId++;
            }
